<template>
    <div class="main">
        ...
        <!-- <div class="danmu">
            <vueDanmaku :danmus="comments" class="danmu-inline" :channels="3" :loop="true" :top="20" :speeds="120"></vueDanmaku>
        </div>
        <div class="emoji-box">
            <VueEmoji ref="emoji" :height="30" :value="myText" @input="onInput" />
